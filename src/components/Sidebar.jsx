...
const Sidebar = ({ isOpen, onClose, activeView, onOpenDashboard, onOpenSituationalAI, onOpenDictionary, onOpenChat, onOpenForecast, onOpenOptimize, onOpenHistory, onOpenSettings, onReset, gamification }) => {
  ...
  return (
    <aside className={`sidebar-enterprise ${isOpen ? 'open' : ''}`}>
      ...
      <nav className="sidebar-nav">
        ...
        />
        <NavItem 
          id="forecast" label="Forecasting" onClick={onOpenForecast} active={activeView}
        ...
        />
        <NavItem 
          id="optimize" label="Optimization" onClick={onOpenOptimize} active={activeView}
        ...
        <NavItem 
          id="history" label="Recent Analyses" onClick={onOpenHistory} active={activeView}
        ...
        />
        <NavItem 
          id="settings" label="Settings" onClick={onOpenSettings} active={activeView}
